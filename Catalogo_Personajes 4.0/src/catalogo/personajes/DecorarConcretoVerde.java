 ...
 * @author Leon1
 */
public class DecorarConcretoVerde extends Decorator{

    public DecorarConcretoVerde(Personaje[] Personajes) {
        super(Personajes);
    }
...
//        String  = "Humanos";
        ...
        if(analisis.indexOf(hum)>0){
            ...
            Personajes[i].personaje="imagenes/humanov.png";
        ...
        if(analisis.indexOf(elf)>0){
            for(int i=0;i<Personajes.length;i++){
            Personajes[i].personaje="imagenes/elfov.png";
        ...
        if(analisis.indexOf(orc)>0){
            for(int i=0;i<Personajes.length;i++){
            Personajes[i].personaje="imagenes/orcov.png";
            System.out.println(hum+Personajes[i].personaje+"esta entrando al if");
            }
        return Personajes;
        }
