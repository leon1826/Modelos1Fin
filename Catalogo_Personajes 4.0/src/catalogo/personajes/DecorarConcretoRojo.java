 ...
 * @author Leon1
 */
public class DecorarConcretoRojo extends Decorator{

    public DecorarConcretoRojo(Personaje[] Personajes) {
        super(Personajes);
    }
...
//        String  = "Humanos";
        ...
        if(analisis.indexOf(hum)>0){
            ...
            Personajes[i].personaje="imagenes/humanor.png";
        ...
        if(analisis.indexOf(elf)>0){
            for(int i=0;i<Personajes.length;i++){
            Personajes[i].personaje="imagenes/elfor.png";
        ...
        if(analisis.indexOf(orc)>0){
            for(int i=0;i<Personajes.length;i++){
            Personajes[i].personaje="imagenes/orcor.png";
            System.out.println(hum+Personajes[i].personaje+"esta entrando al if");
            }
        return Personajes;
        }
